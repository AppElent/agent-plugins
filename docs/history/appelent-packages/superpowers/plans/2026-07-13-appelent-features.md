...
https://github.com/AppElent/agent-plugins (locally
...
```bash
claude plugin marketplace add AppElent/agent-plugins@feat/appelent-catalog
...
- Install (Claude Code): `claude plugin marketplace add AppElent/agent-plugins`
