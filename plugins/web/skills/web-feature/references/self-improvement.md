...
If a skill was reached through `/web:feature apply <feature>`, that run's
...
- **Not about the app's code.** Bugs and ideas about the app you were working in
  are ordinary `/web:project issue` territory, filed against the app's own
...
5. File it with the `issue` procedure in `../../web-project/SKILL.md` —
...
in `../../web-project/SKILL.md`, which routes `/web:project issue` to
